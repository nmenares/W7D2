...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    key: 'createHandler',
    value: function createHandler(event) {
      event.preventDefault();
      var id = (0, _utils2.default)();
      var title = document.querySelector("input.input").value;
      var body = document.querySelector("textarea.input").value;
      var todo = { id: id, title: title, body: body };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            null,
            'Title:',
            _react2.default.createElement('input', { className: 'input', placeholder: 'buy milk', required: true })
          ),
          _react2.default.createElement(
            'label',
            null,
            'Body:',
            _react2.default.createElement('textarea', { className: 'input', cols: '20', rows: '5', required: true })
          ),
          _react2.default.createElement(
            'button',
            { onClick: createHandler, className: 'create-button' },
            'Create Todo!'
          )
        )
      );
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      keys.map(function (key, idx) {
        return _react2.default.createElement(_todo_list_item2.default, { todo: todos[key], key: idx });
      })
    ),
  ...
  switch (action.type) {
    case _todo_actions.RECEIVE_TODOS:
      ...
      action.todos.forEach(function (todo) {
        return result[todo.id] = todo;
      });
      return result;

    case _todo_actions.RECEIVE_TODO:
      var copyState = (0, _merge2.default)({}, state);
      var todo = {};
      todo[action.todo.id] = action.todo;
      copyState = (0, _merge2.default)(copyState, todo);
